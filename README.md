<h1 align="center">Hi 👋, I'm Hitarth Ghia</h1>
<h3 align="center">Cyber Security Student (CoE Track) @ Parul University | Network Engineering & Security Automation</h3>

<p align="center">
  <a href="https://linkedin.com/in/hitarth-ghia">
    <img src="https://img.shields.io/badge/LinkedIn-Connect-0077B5?style=for-the-badge&logo=linkedin&logoColor=white" />
  </a>
  <a href="mailto:ghiahitarth@gmail.com">
...
|--------|------------------------|
| **Network Engineering** | TCP/IP, BGP/OSPF, VLANs, IPv6, Packet Capture (Wireshark/tcpdump), `epoll`/`io_uring` |
| **Security Automation** | Python scripting, C systems programming, Linux hardening, Network monitoring |
| **Systems Programming** | C11, Linux syscalls, `epoll`/`timerfd`/`signalfd`, lock-free atomics, Ring buffers |
| **Observability** | Metrics (SIGUSR1), Structured logging, Health checks, Rate limiting (token bucket) |
...
|---------|------|------------|
| **[Modern-YTDLP-GUI](https://github.com/HitroBro/Modern-YTDLP-GUI)** | Desktop Automation | Threaded yt-dlp GUI, custom Modern UI engine, non-blocking I/O |
| **[bit-blast-arena](https://github.com/HitroBro/bit-blast-arena)** | Game Dev (Python) | Procedural game juice (screen shake, hit-stop), boss mechanics, persistent high-scores |
| **[Blogger](https://github.com/HitroBro/Blogger)** | Static Web | Multi-page blog, responsive CSS, image optimization |
| **[my-pg-project](https://github.com/HitroBro/my-pg-project)** | Web App | Booking & dashboard system, HTML/CSS/JS |
...
<p align="left">
  <a href="https://www.cprogramming.com/"><img src="https://raw.githubusercontent.com/devicons/devicon/master/icons/c/c-original.svg" alt="C" width="44" height="44" title="C" /></a>
  <a href="https://www.python.org"><img src="https://raw.githubusercontent.com/devicons/devicon/master/icons/python/python-original.svg" alt="Python" width="44" height="44" title="Python" /></a>
  <a href="https://www.linux.org/"><img src="https://raw.githubusercontent.com/devicons/devicon/master/icons/linux/linux-original.svg" alt="Linux" width="44" height="44" title="Linux" /></a>
  <a href="https://www.gnu.org/software/bash/"><img src="https://www.vectorlogo.zone/logos/gnu_bash/gnu_bash-icon.svg" alt="Bash" width="44" height="44" title="Bash" /></a>
...
<p align="center">
  <img src="https://komarev.com/ghpvc/?username=HitroBro&color=fe428e&style=for-the-badge" alt="Profile Views" />
</p>